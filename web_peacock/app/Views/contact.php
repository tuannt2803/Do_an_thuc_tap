                ...
                <div class="col-xl-4 col-md-6">
                    <div class="contact_wrap contact_style3">
                        ...
                        <div class="contact_text">
                            <span>Địa chỉ</span>
                            <p>216 Nguyễn Trãi, Thanh Xuân Nam, Hà Nội</p>
                        </div>
                    </div>
                </div>
                <div class="col-xl-4 col-md-6">
                    <div class="contact_wrap contact_style3">
                        ...
                        <div class="contact_text">
                            ...
                            <a href="mailto:info@sitename.com">CSKH@PEACOCK.com</a>
                        </div>
                    </div>
                </div>
                <div class="col-xl-4 col-md-6">
                        ...
                        <div class="row">
                            <?php if ($message == "success") : ?>
                                <div class="alert alert-success">
                                    <strong>Gửi thành công !</strong> Vui lòng liên hệ email CSKH@gear9.com hoặc số điện thoại 0981173413 để thêm thông tin.
                                </div>
