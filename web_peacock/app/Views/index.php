...
<head>
    ...
    <!-- SITE TITLE -->
    <title>PEACOCK Thời trang cho phái nữ</title>
    <!-- Favicon Icon -->
            ...
            <div class="custom-container">
                <div class="nav_block">
                    ...
                    <div class="product_search_form rounded_input">
                        <form action="<?= base_url() ?>/search"  enctype="multipart/form-data" method='POST'>
                        ...
                        <nav class="navbar navbar-expand-lg">
                            ...
                            <div class="collapse navbar-collapse mobile_side_menu" id="navbarSidetoggle">
                                <ul class="navbar-nav">
                                    ...
                                    <li><a class="nav-link nav_item" href="<?= base_url() ?>/guide">Hướng dẫn thanh toán</a></li>
                            </div>
                    ...
                    <div class="banner_section shop_el_slider">
                        <div id="carouselExampleControls" class="carousel slide carousel-fade light_arrow" data-ride="carousel">
                            <div class="carousel-inner">
                                <div class="carousel-item active background_bg" data-img-src="<?= $banner[2]['link'] ?>">
