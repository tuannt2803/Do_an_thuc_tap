                            ...
                            <div class="card-body">
                                ...
                                <form class="form-material form-horizontal m-t-30" method="POST" action="#" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <select class="form-control" name='gender'>
                                                    ...
                                                    <option value="Nam" <?php if ($user['gender']== 'Nam'): echo "selected"; endif;?>>Nam</option>
                                                    <option value="Nữ"<?php if ( $user['gender']== 'Nữ'): echo "selected"; endif;?>>Nữ</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="number"  id="phone" name="phone" value='<?= $user['phone_number']?>'
                                    ...
                                    <button type="submit"
                                        class="btn btn-info waves-effect waves-light m-r-10" name="submit">Lưu</button>
