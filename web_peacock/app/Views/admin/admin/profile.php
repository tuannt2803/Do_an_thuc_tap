...
<div class="row d-flex justify-content-center">
                    ...
                    <div class="col-lg-6 ">
                        <div class="card">
                            <div class="card-body">
                                <center class="m-t-30"> 
                                <img src="<?php echo base_url().$user['image']?>" class="img-circle"
                                        width="150">
                            ...
                            <div class="card-body">
                                ...
                                <h6><?= $user['email']?></h6> <small class="text-muted p-t-30 db">Số điện thoại</small>
                                <h6><?= $user['phone_number']?></h6> <small class="text-muted p-t-30 db">Địa chỉ</small>
                                <h6><?= $user['address']?></h6>
