...
<?= $this->section('content_Admin') ?>
                ...
                <?php $type = ['1' => 'Áo',
                                ...
                                '8' => 'Dây Lưng'];?>
                <div class="row">
                    <h3 style = "margin-top:30px">Thông tin sản phẩm: </h3>
                </div>
                        ...
                        <div class="card">
                            <div class="d-flex flex-row">
                                ...
                                <div class="align-self-center m-l-20">
                                    ...
                                    <h5 class="text-muted m-b-0">Tên sản phẩm</h5>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            <div class="d-flex flex-row">
                                ...
                                <div class="align-self-center m-l-20">
                                    ...
                                    <h5 class="text-muted m-b-0">Loại sản phẩm</h5>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            <div class="d-flex flex-row">
                                ...
                                <div class="align-self-center m-l-20">
                                    ...
                                    <h5 class="text-muted m-b-0">Mã sản phẩm</h5>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            <div class="d-flex flex-row">
                                ...
                                <div class="align-self-center m-l-20">
                                    ...
                                    <h5 class="text-muted m-b-0">Mã code</h5>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            <div class="d-flex flex-row">
                                ...
                                <div class="align-self-center m-l-20">
                                    ...
                                    <h5 class="text-muted m-b-0">Giá</h5>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7">
                        <div class="card">
                            <div class="box bg-dark text-center">
                                <h5 class="text-white">Nhiều ảnh</h5>
                            </div>
                            <div class="card-body">
