...
<div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h5><b>Hóa đơn: </b> <span><?= $user_detail['id'] ?></span></h5>
                                <hr>
                                <div class="row">
                                    <div class="col-md-12">
                                        <!-- <div class="pull-left">
                                        ...
                                        <div class="">
                                            <address>
                                                ...
                                                <h4 class="font-bold">Người nhận :<?= $user_detail['fullname']?></h4>
                                                ...
                                                <p class="m-t-30"><b>Ngày đặt :</b> <i class="fa fa-calendar"></i>
                                                    <?= $user_detail['create_on']?></p>
                                                <p><b>Hạn đặt :</b> <i class="fa fa-calendar"></i><?php echo date('Y-m-d', strtotime($user_detail['create_on']. ' + 7 days')); ?></p>
                                            </address>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        ...
                                        <div class="text-right">
                                            ...
                                            <button onClick="javascript:window.print();"
                                                class="btn btn-default btn-outline" type="button"> <span><i
                                                        class="fa fa-print"></i> In</span> </button>
                                        </div>
                                    </div>
                                </div>
                            </div>
