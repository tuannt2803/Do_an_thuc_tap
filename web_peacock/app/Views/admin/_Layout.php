...
<body class="skin-default-dark fixed-layout">
    ...
    <div id="main-wrapper">
        ...
        <aside class="left-sidebar">
            ...
            <div class="scroll-sidebar">
                    ...
                    <div class="user-pro-body">
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu animated flipInY">
                                <!-- text-->
                                <a href="<?php echo base_url() . '/admin/profile/' . $_SESSION['user']['id']; ?>" class="dropdown-item"><i class="ti-user"></i>Thông tin cá nhân</a>
                                <!-- text-->
                                <a href="<?= base_url() ?>/admin/logout" class="dropdown-item"><i class="fas fa-power-off"></i>Đăng xuất</a>
                                <!-- text-->
                            </div>
                        </div>
                    </div>
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        <li class="nav-small-cap">--- TỔNG QUAN</li>
                        <li>
                        ...
                        <li> <a class="waves-effect waves-dark" href="<?= base_url() ?>/admin/mailbox" aria-expanded="false"><i class="icon-envelope"></i><span class="hide-menu">Hòm thư</span></a>

                        </li>

                        <li class="nav-small-cap">--- QUẢN LÝ</li>

                        <li> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="icon-people"></i><span class="hide-menu">Tài khoản</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="<?= base_url() ?>/admin/admin">Danh sách tài khoản</a></li>
                                <li><a href="<?= base_url() ?>/admin/admin/add">Thêm tài khoản</a></li>
                            </ul>
                        </li>
                        <li> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="icon-docs"></i><span class="hide-menu">Sản phẩm</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="<?= base_url() ?>/admin/product">Danh sách sản phẩm</a></li>
                                <li><a href="<?= base_url() ?>/admin/product/add">Thêm sản phẩm</a></li>

                            </ul>
                        </li>
                        <li> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="fab fa-cuttlefish"></i><span class="hide-menu">Danh mục sản phẩm</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="<?= base_url() ?>/admin/category">Danh sách danh mục</a></li>
                                <li><a href="<?= base_url() ?>/admin/category/add">Thêm danh mục</a></li>
                            </ul>
                        </li>

                        <li> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="ti-receipt"></i><span class="hide-menu">Đơn hàng</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="<?= base_url() ?>/admin/invoice">Danh sách đơn hàng</a></li>
                                <li><a href="<?= base_url() ?>/admin/invoice/add">Thêm đơn hàng</a></li>
                                <!-- <li><a href="#">History</a></li> -->
                            </ul>
                        </li>

                        <li> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="ti-receipt"></i><span class="hide-menu">Nhà cung cấp</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="<?= base_url() ?>/admin/supplier">Danh sách nhà cung cấp</a></li>
                                <li><a href="<?= base_url() ?>/admin/supplier/add">Thêm nhà cung cấp</a></li>
                            </ul>
                        </li>

                        <li> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="ti-receipt"></i><span class="hide-menu">Bình luận</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="<?= base_url() ?>/admin/comment">Danh sách bình luận</a></li>
                                <li><a href="<?= base_url() ?>/admin/comment/add">Thêm bình luận</a></li>
                            </ul>
                        </li>
        ...
        <!-- ============================================================== -->
        <footer class="footer">
            © 2021 All Rights Reserved by Nhom 8
        </footer>
        <!-- ============================================================== -->
        <!-- End footer -->
        <!-- ============================================================== -->
    ...
    <script src="<?= base_url() ?>/public/admin/assets/node_modules/dff/test2.js" type="text/javascript"></script>
    <script>
